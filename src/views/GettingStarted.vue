<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
      ...
      <p class="mb-4 text-accent">Follow these simple steps to integrate the Mobilozophy JavaScript library into your website and start your journey towards enhanced customer engagement:</p>

      <ol class="mb-6 list-decimal list-inside">
        <li class="mb-4">
          <strong class="text-primary">Add the Mobilozophy JavaScript:</strong>
          <p class="mt-2 text-accent">Copy and paste this script just before the closing <code class="bg-gray-200 px-1 py-0.5 rounded text-red-600 font-mono">&lt;/body&gt;</code> tag of your HTML:</p>
...
<span class="text-pink-400">&lt;/script&gt;</span></code></pre>
    ...
    <div class="mb-8">
      ...
      <p class="mb-4 text-accent">By adding this simple script, you've unlocked a powerful suite of features, each designed to enhance your customer engagement strategy:</p>
      ...
      <p class="mt-4 text-accent">All these features are now at your fingertips through simple JavaScript calls, embodying our commitment to providing powerful tools without the need for complex integrations.</p>
    </div>

    <div class="mb-8">
      <h2 class="mb-4 text-2xl font-semibold text-secondary">Debugging and Verbose Logging</h2>
      <p class="mb-4 text-accent">To aid in development and troubleshooting, we've included powerful debugging tools:</p>
      
      <h3 class="mt-6 mb-2 text-xl font-semibold text-secondary">Console Output</h3>
      <p class="mb-4 text-accent">With verbose logging enabled, you'll see detailed information in your browser's console. Here's how to access the console:</p>
      
      <ol class="list-decimal list-inside mb-4 text-accent">
      ...
      <p class="mb-4 text-accent">Once in the console, you'll see output similar to this:</p>
...
<span class="text-green-300">Pageview tracking data sent:</span> Object</code></pre>
      ...
      <p class="mb-4 text-accent">A debug widget will appear at the bottom-left corner of your screen when verbose logging is enabled:</p>
      <div class="mb-4">
      ...
      <p class="mb-4 text-accent">Clicking this button opens a debug window with the following information:</p>
      ...
      <div class="mt-6 p-4 bg-yellow-100 rounded-lg border-2 border-yellow-400">
        <p class="text-yellow-800"><strong>Note:</strong> While verbose logging is invaluable during development and testing, it's recommended to disable it in production environments for optimal performance and to prevent sensitive information from being exposed.</p>
      </div>
    </div>
